...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-teal-200 to-cyan-300 font-quattrocento overflow-hidden">
      {/* Hamburger Menu */}
      <HamburgerMenu />

      {/* Main Content Container with Scroll */}
      <div className="max-w-6xl mx-auto px-4 py-12 max-h-screen overflow-y-auto">
