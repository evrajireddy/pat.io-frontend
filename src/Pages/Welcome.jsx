...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-quattrocento">
      ...
      <section className="hidden md:block py-16 bg-glass" style={{ display: 'none' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Introducing the Pat.io Model</h2>
            <p className="mt-2 md:mt-4 text-base md:text-lg text-gray-600">
              Our AI-powered language model is designed to provide instant, accurate, and engaging information
              on Social Security processes and requirements in New York City.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-6 md:gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-white shadow-lg rounded-lg p-6 md:p-8 text-center">
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">Cost Efficiency</h3>
              <p className="text-sm md:text-lg text-gray-600">
                Pat.io delivers valuable insights while keeping operational costs low, ensuring accessibility
                for all users.
              </p>
            </div>
