  ...
  resources: {
    en: {
      translation: {
        ...
        LL30Selected: `Local Law 30 of 2017 (LL30) in New York City is one of the strongest laws in the country and requires that covered city agencies appoint a language access coordinator, develop language access implementation plans, provide telephonic interpretation in at least 100 languages, translate their most commonly distributed documents into the 10 designated citywide languages, and post signage about the availability of free interpretation services, among other requirements. You can ask me more about this law and its impact on your rights. Also you can follow the link below to learn more about the law in your language, or call the Deputy Director of Language Access at 212-346-6047 with you questions.`,
        ITIN: "What is an ITIN?",
        ITINSelected:
          "ITIN stands for Individual Taxpayer Identification Number. It is a unique 9-digit number assigned to individuals who are not eligible to obtain a Social Security Number (SSN) due to their immigration status. ITINs are used for tax filing purposes and allow individuals to file their taxes and receive refunds. You can ask me more about ITIN and how to apply for one. Or you can follow the link below to learn more about ITIN in your language.",
        ...
        type: "Talk to Pat.io...",
        irsITIN: "Learn more about ITIN from the IRS.",
        nycITIN: "Learn more about ITIN.",
        TIN: "Learn more about the different Taxpayer Identification Numbers.",
        learnLL30: "Learn more about NYC Local Law 30 in your language.",
        startOver: "Reset",
